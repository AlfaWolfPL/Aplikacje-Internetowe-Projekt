...
function runSingleCsvImport(string $filePath): array {
    ...
    if (($handle = fopen($filePath, "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
            ...
            try {
                ...
                $sql = "INSERT INTO titles (id, title, description, kind, year) VALUES (:id, :title, :desc, :kind, :year)";
